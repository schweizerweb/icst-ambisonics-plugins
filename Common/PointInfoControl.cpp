    ...
    : pEditablePoints(pEditablePoints), pPointSelection(pPointSelection)
{
    ...
    labelName->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelX->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelY->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelZ->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelCartesian->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelA->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelE->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelD->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelPolar->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    labelCH->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
...
void PointInfoControl::resized()
{
    ...
    textName->setBounds (proportionOfWidth (0.4f) + 0, 8, proportionOfWidth (0.3487f), 24);
    labelX->setBounds ((proportionOfWidth (0.4f) + 0) + 0 - 24, (8 + 24 - -8) + 0, 24, 24);
    textX->setBounds (proportionOfWidth (0.4f) + 0, (8 + 24 - -8) + 0, roundToInt ((roundToInt (proportionOfWidth (0.1359f) * 1.0f)) * 1.0f), 24);
    labelY->setBounds ((proportionOfWidth (0.6205f) + 0) + 0 - 24, (8 + 24 - -8) + 0, 24, 24);
    textY->setBounds (proportionOfWidth (0.6205f) + 0, 40, roundToInt ((roundToInt (proportionOfWidth (0.1359f) * 1.0f)) * 1.0f), 24);
    labelZ->setBounds ((proportionOfWidth (0.841f) + 0) + 0 - 24, 40, 24, 24);
    textZ->setBounds (proportionOfWidth (0.841f) + 0, 40, roundToInt (proportionOfWidth (0.1359f) * 1.0f), 24);
    labelCartesian->setBounds (0, 8 + 24 - -8, 80, 24);
    labelA->setBounds (proportionOfWidth (0.4f) + 0 - 24, (8 + 64) + 0, 24, 24);
    textA->setBounds (proportionOfWidth (0.4f), 72, roundToInt (proportionOfWidth (0.1359f) * 1.0f), 24);
    labelE->setBounds (proportionOfWidth (0.6205f) + 0 - 24, 72, 24, 24);
    textE->setBounds (proportionOfWidth (0.6205f), 72, roundToInt (proportionOfWidth (0.1359f) * 1.0f), 24);
    labelD->setBounds (proportionOfWidth (0.841f) + 0 - 24, 72, 24, 24);
    textD->setBounds (proportionOfWidth (0.841f), 72, proportionOfWidth (0.1359f), 24);
    labelCH->setBounds ((proportionOfWidth (0.841f) + 0) + 0 - 32, 8, 32, 24);
    textCH->setBounds (proportionOfWidth (0.841f) + 0, 8, roundToInt (proportionOfWidth (0.1359f) * 1.0f), 24);
