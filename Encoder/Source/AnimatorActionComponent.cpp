    ...
    : pSourceSet(_pSourceSet), pAnimatorAction(_pAnimatorAction)
{
    ...
    labelGroup->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationX->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationY->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationZ->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationOriginX->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationOriginY->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelRotationOriginZ->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
    ...
    labelStretchSimple->setFont (juce::Font (juce::FontOptions("Regular", 15.00f, juce::Font::plain)));
