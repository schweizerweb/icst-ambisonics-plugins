...
public:
    ...
    void restoreDefaultsInternal() override
    {
        ...
        createPreset("Dolby Atmos 10.2", {
            ...
            { -0.965926, 0.0, -0.258819, "LFE-L", false, 1 }, // TODO???
            { 0.965926, 0.0, -0.258819, "LFE-R", false, 1 }   // TODO???
        });
        ...
        createPreset("Dolby Atmos 22.2", {
            ...
            { -0.965926, 0.0, -0.258819, "LFE-L", false, 2 },
            { 0.965926, 0.0, -0.258819, "LFE-R", false, 2 }
        });
